    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Telegram имя', max_length=30, unique=True, verbose_name='Telegram Username')),
                ...
                ('language', models.CharField(default='ru', help_text='Язык', max_length=5, verbose_name='Язык')),
                ('rating_count', models.PositiveIntegerField(default=0, help_text='Кол-во отзывов', verbose_name='Кол-во отзывов')),
                ...
                ('city', models.ForeignKey(default=1, help_text='Город', on_delete=django.db.models.deletion.PROTECT, to='ework_locations.city', verbose_name='Город')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.TextField(blank=True, help_text='Комментарий', max_length=250, null=True, verbose_name='Комментарий')),
